...
//	public static By OtpError = By.xpath("//*[@text='You have entered incorrect or expired OTP']");
	...
	//checkbox1
	public static By ckycCheckBox = By.xpath("(//*[@text=' I allow ring to run Credit Bureau checks and provide consent for CKYC']/preceding-sibling::android.view.ViewGroup/descendant::android.view.ViewGroup)[4]");
	...
	public static By objIAcceptCheckBox = By.xpath("//*[@text='I accept the Ring’s Terms & Conditions & IT Act 2000']/preceding-sibling::android.widget.CheckBox");
...
//	public static By objLoginFacebook = By.xpath("//*[@text='Continue with Facebook']");
	//Terms of services footer link text
	public static By objTermsLink_PrivacyFooter = By.xpath("//*[contains(@text,'Terms of Services & Privacy Policy')]");
//	//truecaller skip button
//	public static By objTruSkipBtn = By.xpath("//*[@text='SKIP']");
//	//None of the above button
//	public static By objNoneBtn = By.xpath("//*[@resource-id='com.google.android.gms:id/cancel']");
