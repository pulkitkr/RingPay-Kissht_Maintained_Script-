...

	{
		...
		if (getTestName().equals("Android_UserSessionManagement")) {
			setPlatfrom(Utilities.setPlatform);
				...
				|| methodName.equals("zeelogoVerificationInPlayer") || methodName.equals("merchantFlow")
				...
				|| methodName.equals("WebRingApp") || methodName.equals("offerFlow") ||  methodName.equals("ringInstaWhitelist")){
			setPlatfrom("Web");
		}
